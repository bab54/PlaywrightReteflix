...
test.describe.only('Gallery page footer', () => {

  test('Valid Gallery page Footer', { tag: ['@only'] }, async ({ Given, footerGalleryPage, When, Then }) => { 
